...
# Adopted 2021-10-28 by Reto Trappitsch for dll loading.

import ctypes


def load_wlm_data_dll(dllpath: str) -> ctypes.WinDLL:
    """Load the Wavelengthmeter Data DLL.

    :param dllpath: Path to the DLL.

    :return: DLL wrapped in a ctypes.WinDLL with configured headers.
    """
    dll = ctypes.WinDLL(dllpath)

    # LONG_PTR Instantiate(long RFC, long Mode, LONG_PTR P1, long P2)
    dll.Instantiate.argtypes = [
        ctypes.c_long,
        ctypes.c_long,
    ...
    dll.WaitForWLMEventEx.argtypes = [
        ctypes.POINTER(ctypes.c_long),
        ctypes.POINTER(ctypes.c_long),
        ctypes.POINTER(ctypes.c_long),
        ctypes.POINTER(ctypes.c_double),
    ...
    dll.WaitForNextWLMEvent.argtypes = [
        ctypes.POINTER(ctypes.c_long),
        ctypes.POINTER(ctypes.c_long),
        ctypes.POINTER(ctypes.c_double),
    ]
    ...
    dll.WaitForNextWLMEventEx.argtypes = [
        ctypes.POINTER(ctypes.c_long),
        ctypes.POINTER(ctypes.c_long),
        ctypes.POINTER(ctypes.c_long),
        ctypes.POINTER(ctypes.c_double),
    ...
    # dll.GetAutoExposureSetting.argtypes = [
    #     ctypes.c_long,
    #     ctypes.c_long,
    #     ctypes.POINTER(ctypes.c_long),
    #     ctypes.POINTER(ctypes.c_double),
    ...
    # dll.SetAutoExposureSetting.argtypes = [
    #     ctypes.c_long,
    #     ctypes.c_long,
    #     ctypes.c_long,
    #     ctypes.c_double,
    ...
    dll.GetSwitcherSignalStates.argtypes = [
        ctypes.c_long,
        ctypes.POINTER(ctypes.c_long),
        ctypes.POINTER(ctypes.c_long),
    ]
    ...
    dll.GetAutoCalSetting.argtypes = [
        ctypes.c_long,
        ctypes.POINTER(ctypes.c_long),
        ctypes.c_long,
        ctypes.POINTER(ctypes.c_long),
    ...
    dll.SetAutoCalSetting.argtypes = [
        ctypes.c_long,
        ctypes.c_long,
        ctypes.c_long,
        ctypes.c_long,
    ...
    dll.GetPatternDataNum.argtypes = [
        ctypes.c_long,
        ctypes.c_long,
    ...
    dll.GetLaserControlSetting.argtypes = [
        ctypes.c_long,
        ctypes.c_long,
        ctypes.POINTER(ctypes.c_long),
        ctypes.POINTER(ctypes.c_double),
    ...
    dll.SetLaserControlSetting.argtypes = [
        ctypes.c_long,
        ctypes.c_long,
        ctypes.c_long,
        ctypes.c_double,
